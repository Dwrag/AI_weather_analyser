...
# ----------------------------------------------------------------------
# Sidebar - training status / retrain button
# ----------------------------------------------------------------------
...
# ---------------- LEFT: inputs / location / weather / prediction -------
with col_left:
...
with col_right:
    ...
    if hist is None:
        ...
        # top hotspot markers (grid-binned by rounding lat/lon)
...
# ----------------------------------------------------------------------
# Full-width dashboard, below both columns
# ----------------------------------------------------------------------
hist = load_historical_data()
