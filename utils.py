"""
utils.py
Shared logic between training and the live Streamlit app.
Keeping this in one place guarantees the model is trained on
EXACTLY the same feature engineering that the live app uses at
prediction time (a very common source of bugs in ML apps).
"""
